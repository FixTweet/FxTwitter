...
FixTweet generates embeds compliant with the following standards:
   ...
   * `OpenGraph <https://ogp.me/>`_
   * `Twitter Cards <https://developer.twitter.com/en/docs/tweets/optimize-with-cards/overview/abouts-cards.html>`_
...
Some platforms also have limitations, for instance:
   ...
   * Telegram video embeds cannot exceed 20 MB. This can cause longer videos to break in Telegram. We are `investigating workarounds and fixes <https://github.com/FixTweet/FixTweet/issues/39>`_.
